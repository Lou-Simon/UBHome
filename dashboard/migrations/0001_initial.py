    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='dashboard.forumpost', verbose_name='Post')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='author',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='forum_posts', to='dashboard.student', verbose_name='Auteur'),
        ),
        migrations.CreateModel(
            name='Email',
            fields=[
